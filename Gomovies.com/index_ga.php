...
<body>
    <header class="navbar navbar-inverse navbar-fixed-top wet-asphalt" role="banner">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index_ga.php" style="height:80px;"><img src="images/logo.png" alt="logo"></a>
            </div>
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav navbar-left" style="font-size:15px;">
                    <li class="active"><a href="index_ga.php">Home</a></li>
 ...
 if(!(isset($_SESSION['username'])))
 {
			...
			?>
			  <form class="navbar-form pull-right" name="form1" action="index_ga.php" method="post" >
